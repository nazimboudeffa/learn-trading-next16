        ...
        <div className="max-w-2xl w-full bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 p-8 flex flex-col items-center">
          ...
          <div className="w-full flex flex-col items-center mb-4 gap-6">
            ...
            <div className="flex gap-6 mt-4">
              <button
                className={`px-8 py-3 rounded-full font-bold shadow-md transition focus:outline-none focus:ring-2 focus:ring-green-300 focus:ring-offset-2 ${buyClicked || sellClicked ? 'bg-gray-400 cursor-not-allowed' : 'bg-green-500 hover:bg-green-600 text-white'}`}
                onClick={() => {
                  setBuyClicked(true);
              ...
              <button
                className={`px-8 py-3 rounded-full font-bold shadow-md transition focus:outline-none focus:ring-2 focus:ring-red-300 focus:ring-offset-2 ${buyClicked || sellClicked ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-500 hover:bg-red-600 text-white'}`}
                onClick={() => {
                  setSellClicked(true);
                  setBuyClicked(false);
                  startFutureDataAnimation();
          ...
          {buyClicked && entryCandle && (
            <div className="mt-8 w-full p-4 rounded-lg bg-green-50 border border-green-200 text-green-800 text-center">
          ...
          {sellClicked && entryCandle && (
            <div className="mt-8 w-full p-4 rounded-lg bg-red-50 border border-red-200 text-red-800 text-center">
